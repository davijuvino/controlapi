...
public class Msg {
    ...
    public static final String USER_NOT_FOUND = "Usuário não encontrado com userId %d";
    public static final String USER_CREATION_ERROR = "Erro inesperado ao criar usuário: %s";
    public static final String USER_UPDATE_ERROR = "Erro inesperado ao atualizar usuário: %s";
    public static final String USER_DELETION_SUCCESS = "Usuário excluído com sucesso!";
    public static final String USER_ALREADY_EXISTS = "Usuário com email %s já existe.";
    public static final String USER_CREATION_SUCCESS = "Usuário criado com sucesso com ID: %d";
    public static final String USER_UPDATE_SUCCESS = "Usuário atualizado com sucesso com ID: %d";
}